...
@NamedQueries({
    ...
    @NamedQuery(name = "Osoba.findByMissingVaha", query = "SELECT o FROM Osoba o WHERE o.vaha IS NULL")})
public class Osoba implements Serializable {
    ...
    public String toString() {
        return "Osoba{" + "id=" + id + ", meno=" + meno + ", narodena=" + narodena + ", vaha=" + vaha + ", vyska=" + vyska + '}';
    }
