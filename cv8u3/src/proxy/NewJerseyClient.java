...
/**
 * Jersey REST client generated for REST resource:ZoznamResource [zoznam]<br>
 * USAGE:
 * <pre>
...
public class NewJerseyClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/WebAppTest/webresources";

    public NewJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("zoznam");
    }
