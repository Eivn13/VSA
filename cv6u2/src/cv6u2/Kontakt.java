...
public class Kontakt implements Serializable {
    ...
    public String toString() {
        return "Kontakt{" + "id=" + id + ", mail=" + mail + ", tel=" + tel + ", patriOsobe=" + patriOsobe + '}';
    }

    
    /**
     * @return the patriOsobe
     */
    public Osoba getPatriOsobe() {
        return patriOsobe;
    }

    /**
     * @param patriOsobe the patriOsobe to set
     */
    public void setPatriOsobe(Osoba patriOsobe) {
        this.patriOsobe = patriOsobe;
    }
